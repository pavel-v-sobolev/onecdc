...
# Соединения, которые работают непрерывно: цикл чтения изменений и два потока отметки живости —
# реестр незавершённых merge и захват объекта под выгрузку.
...
#
# Делим так: в pool_size — то, что работает непрерывно (цикл изменений и две отметки живости);
# страницы выгрузки, витрины и расписания идут через overflow. Разница в том, что соединение из
