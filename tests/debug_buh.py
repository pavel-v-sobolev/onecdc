...
# Настройки стенда — в tests/buh_demo1.env рядом (в репозитории; своё — в
# tests/buh_demo1.local.env или в переменных окружения, см. debug_config).
CONTOUR = contour('buh_demo1')
